...
public class LUDecompositionFloat implements java.io.Serializable {
 ...
 * ------------------------ */
   ...
   */
   ...
   public LUDecompositionFloat (FloatMatrix A) {
...
/* ------------------------
   ...
   *\
   ...
   public LUDecompositionFloat (Matrix A, int linpackflag) {
      // Initialize.
      LU = A.getArrayCopy();
      m = A.getRowDimension();
      n = A.getColumnDimension();
 ...
 * ------------------------ */
   ...
   */
   ...
   public FloatMatrix solve (FloatMatrix B) {
      ...
      FloatMatrix Xmat = B.getFloatMatrix(piv,0,nx-1);
