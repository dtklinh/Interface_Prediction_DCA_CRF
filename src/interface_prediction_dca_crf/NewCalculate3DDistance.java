...
//        String chain1 = "A", chain2 = "B";
            ...
            String path2PDbFile = "Input/Zellner_Homodimer_5/PDB/" + ProtID + ".pdb";
...
//            NewProteinComplex Cmpl = new NewProteinComplex(path2PDbFile, ProtID, chain1, chain2);
            ...
            MyIO.WriteLstToFile("Input/Zellner_Homodimer_5/3D/" + ProtID + "_" + chain1 + ".3d", C1.pairwiseDistance());
            MyIO.WriteLstToFile("Input/Zellner_Homodimer_5/3D/" + ProtID + "_" + chain2 + ".3d", C2.pairwiseDistance());
//            MyIO.WriteLstToFile("Input/Zellner_Homodimer_5/3D/" + ProtID + ".3d", Cmpl.pairwiseDistance());
        }
    }
}
