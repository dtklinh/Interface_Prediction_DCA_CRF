...
//        String chain1 = "A", chain2 = "B";
            ...
            String path2PDbFile = "Input/Zellner_Homodimer/PDB/" + ProtID + ".pdb";
            ...
            MyIO.WriteLstToFile("Input/Zellner_Homodimer/3D/" + ProtID + "_" + chain1 + ".3d_Any_VdW", C1.pairwiseDistance());
