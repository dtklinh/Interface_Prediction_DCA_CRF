...
import HomodimaProtein.ThreadComplex;
...
public class RunDCA {
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        int num_cpu = 1;
        String DirMSAFile = Configuration.Dir2MSA;
        String DirResultFile = Configuration.Dir2DCA;
        List<String> lst_tmp = utils.Utils.dir2list(Configuration.Dir2MSA);
